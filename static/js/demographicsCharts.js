...
function createDemographicsChart(a_x_value, a_y_value, a_state_list = [ "Georgia" ], a_chart_index = 0) {
    ...
    //    a_chart_index: The id of the chart to place the chart (e.g., "demo_chart_0") 
        ...
        const plotConfig = {
            ...
            "Population": { axis_label: "Population (thousands)", scale_factor: 0.001, max_range: NaN },
            ...
            "Unemployment": { axis_label: "Unemployment Rate (%)", scale_factor: 100.0, max_range: 100 },
